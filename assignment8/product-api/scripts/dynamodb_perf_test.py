#!/usr/bin/env python3
"""
Same 150-operation test as Step I (mysql_perf_test.py), default output:
dynamodb_test_results.json — for Homework 8 Step II / Step III comparison.
"""
...
def main() -> None:
    p = argparse.ArgumentParser(description="DynamoDB cart API 150-operation perf test (Step II)")
    p.add_argument("--base-url", default="http://127.0.0.1:8080")
    p.add_argument("--api-key", default="test")
    p.add_argument("--output", default="dynamodb_test_results.json")
